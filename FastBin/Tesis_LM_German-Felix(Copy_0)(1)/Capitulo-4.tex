...
En ocasiones, es posible descomponer un m\'odulo de persistencia en una suma directa de modulos de intervalos $\mathbb{I}_{\cpar{b,d}}$ de la forma
...
Como consecuencia, el conjunto de intervalos resultantes es independiente de la descomposici\'on de $\mathbb{V}$ y es llamado el c\'odigo de barras de persistencia de $V$.