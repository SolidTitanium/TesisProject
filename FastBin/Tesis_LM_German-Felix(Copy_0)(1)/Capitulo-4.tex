...
Cada intervalo $\cpar{a,a'}$ puede ser representado en el plano $\mathbb{R}$ por el punto $\cpar{a,a'}$.
El conjunto de puntos resultante es llamado el diagrama de persistencia de $f$.
Es de notar que la funcion puede tener multiples copias del mismo intervalo en su codigo de barras de persitencia.
